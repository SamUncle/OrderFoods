...
//            }
//        }
////        let provider = MoyaProvider<ApiServiceManager>()
...
//        }
        ...
        let observable = SampleApiProvider.rx.request(.music(page: page)).map([Music].self, atKeyPath: "music", using: JSONDecoder(), failsOnEmptyData: false).asObservable()
